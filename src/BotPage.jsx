...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  body{background:#F8FBFF;-webkit-font-smoothing:antialiased;overflow:hidden}
  @media(min-width:768px){
    html,body{height:auto;min-height:100%;overflow:auto}
    body{overflow-y:auto}
    #root{height:auto;min-height:100%;display:flex;flex-direction:column;align-items:center}
    .ally-root{max-width:700px;width:100%;border-left:1px solid #8dc2f2;border-right:1px solid #8dc2f2}
  ...
  @keyframes floodlight{0%,100%{opacity:.6}50%{opacity:1}}
  ...
  .dot{width:7px;height:7px;border-radius:50%;background:#8dc2f2;display:inline-block;animation:bn 1.1s infinite}
  .dot:nth-child(2){animation-delay:.18s}.dot:nth-child(3){animation-delay:.36s}
  textarea{flex:1;background:transparent;border:none;outline:none;resize:none;color:#0a1628;font-family:'Barlow',sans-serif;font-size:17px;line-height:1.65;padding:0;max-height:140px;overflow-y:auto}
  textarea::placeholder{color:rgba(10,22,40,.4)}
  input[type=text],input[type=email]{background:#fff;border:2px solid #8dc2f2;border-radius:10px;padding:12px 16px;color:#0a1628;font-family:'Barlow',sans-serif;font-size:16px;outline:none;width:100%}
  input[type=text]::placeholder,input[type=email]::placeholder{color:rgba(10,22,40,.4)}
  input[type=checkbox]{width:20px;height:20px;accent-color:#8dc2f2}
  ...
  .scp{width:100%;padding:12px;border:2px solid #8dc2f2;border-radius:12px;background:#fff;color:#8dc2f2;font-family:'Barlow Condensed',sans-serif;font-size:13px;letter-spacing:1px;cursor:pointer;transition:all .2s}
  .scp:hover{background:#8dc2f2;color:#fff}
  ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:#8dc2f2;border-radius:2px}
`;
